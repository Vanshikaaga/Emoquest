...
# Initialize Mediapipe Face Mesh for landmarks and Face Detection
...
while cap.isOpened():
    ...
    cv2.putText(frame, f"Smile: {int(smile_confidence)}%", (30, 50),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 215, 0), 2)
    cv2.putText(frame, f"Emotion: {emotion_text}", (30, 100),
